      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('home/karyawan'); ?>"><i class="fa fa-group"></i> <span>Data Karyawan</span></a>
          </ul>
        </li>
        <li></li>
        <li><a href="<?php echo base_url('home/presensi'); ?>"><i class="fa fa-male"></i> <span>Presensi</span></a></li>
