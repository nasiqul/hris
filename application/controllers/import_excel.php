...
class import_excel extends CI_Controller {
    ...
    public function upload(){
      $fileName = time().$_FILES['file']['name'];
        ...
        public function exportOvertime($bulan){
        ...
        $excel->setActiveSheetIndex(0)->setCellValue('A3', "NIK"); // Set kolom A3 dengan tulisan "NO"
        $excel->setActiveSheetIndex(0)->setCellValue('B3', "Nama Karyawan"); // Set kolom B3 dengan tulisan "NIS"
        $excel->setActiveSheetIndex(0)->setCellValue('C3', "Cost Center"); // Set kolom C3 dengan tulisan "NAMA"
        $excel->setActiveSheetIndex(0)->setCellValue('D3', "Jam"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
        ...
        $isi = $this->over_model_new->export_over_time($bulan);
